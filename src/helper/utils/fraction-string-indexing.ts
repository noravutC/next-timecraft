...
export const assignBulkIndexes = <T extends { orderFraction?: string | null | undefined }>(
  payloads: T[],
  ...
  const generatedKeys = generateNKeysBetween(prevOrder, nextOrder, payloads.length);
