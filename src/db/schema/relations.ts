...
export const projectMembersTableRelations = relations(projectMembersTable, ({ one }) => ({
...
export const columnsTableRelations = relations(columnsTable, ({ one, many }) => ({
  project: one(projectsTable, {
...
export const tasksTableRelations = relations(tasksTable, ({ one, many }) => ({
  ...
  dependentTasks: many(taskDependenciesTable, { relationName: "task_dependents" }),
}));
...
export const taskDependenciesTableRelations = relations(taskDependenciesTable, ({ one }) => ({
  task: one(tasksTable, {
